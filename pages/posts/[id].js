...
import postsPageInitialPaths6e5c0Resource from '../../resources/posts-page-initial-paths-6e5c0'
import postsPageInitialPropsFbc62Resource from '../../resources/posts-page-initial-props-fbc62'
  ...
  return (
    <>
      <div className="posts11-container">
        <Head>
          <title>Posts1 - Regional Configuration Liaison</title>
          <meta
            property="og:title"
            content="Posts1 - Regional Configuration Liaison"
          />
        </Head>
        <DataProvider
...
export async function getStaticPaths() {
  try {
    const response = await postsPageInitialPaths6e5c0Resource({})
    return {
...
export async function getStaticProps(context) {
  try {
    const response = await postsPageInitialPropsFbc62Resource({
      ...context?.params,
    })
    if (!response?.data?.[0]) {
      return {
